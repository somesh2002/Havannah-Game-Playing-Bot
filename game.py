...
from players.ai3 import AIPlayer as AIPlayer3
from players.ai4 import AIPlayer as AIPlayer4
from players.ai5 import AIPlayer as AIPlayer5
from players.ai6 import AIPlayer as AIPlayer6
from players.ai7 import AIPlayer as AIPlayer7
from players.ai9 import AIPlayer as AIPlayer9
...
def make_player(name, num, timer=PLAYER_TIME):
    if name == 'ai':
        ...
        return AIPlayer3(num, timer)
    elif name == 'ai4':
        return AIPlayer4(num, timer)
    elif name == 'ai5':
        return AIPlayer5(num, timer)
    elif name == 'ai6':
        return AIPlayer6(num, timer)
    elif name == 'ai7':
        return AIPlayer7(num, timer)
    elif name == 'ai9':
        return AIPlayer9(num, timer)
    elif name == 'ai10':
...
if __name__ == '__main__':
    player_types = ['ai', 'ai2','ai3','ai4','ai5','ai6','ai7','ai8','ai9','ai10','ai11','ai12','ai13','random', 'human']
